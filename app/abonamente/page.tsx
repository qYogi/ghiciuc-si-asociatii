  ...
  return (
    <div className={`bg-tertiary`}>
      ...
      <div className={`${styles.abBody} `}>
        <main className={` max-w-7xl rounded-lg mx-auto px-4 sm:px-6 md:py-12`}>
          ...
          <p className="text-base font-[500] sm:text-lg p-3 rounded-lg text-secondary mb-8 sm:mb-10 leading-relaxed text-center">
            Societatea noastră de avocatură asigură clienților servicii juridice
            personalizate, în baza unui contract de asistență juridică
            permanentă (abonament lunar sau anual), adaptat nevoilor specifice
            fiecăruia.
          </p>
          ...
          <div className="bg-muted bg-opacity-30 p-4 sm:p-6 rounded-xl mb-8 sm:mb-10">
            ...
            <p className="text-secondary leading-relaxed text-sm sm:text-base">
              ...
              estimată. Oferta noastră este flexibilă și transparentă, adaptată
              perfect cerințelor dumneavoastră.
            </p>
          </div>
